...
* 当用户允许授权并回传给应用code值时，应用程序应该把code值，通过post的方式来兔耳的 http://www.tuer.me/oauth/access_token 换取token值。
...
* 删除评论 <em>授权</em>
  ...
  > http://api.tuer.me/comment/del/id [id,diaryid]  
  > {code:'success',msg:'删除成功'}  //这里的id要传入mongo id，为commentid
